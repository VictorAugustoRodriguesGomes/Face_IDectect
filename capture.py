...
if detector == "ssd":
    network = cv2.dnn.readNetFromCaffe("file/deploy.prototxt.txt", "file/res10_300x300_ssd_iter_140000.caffemodel")
else:
    face_detector = cv2.CascadeClassifier('file\haarcascade_frontalface_default.xml')
